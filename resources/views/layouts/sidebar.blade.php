<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <!-- Layouts -->
        <!--  $active == 'menu-peminjaman' || $active == 'menu-pengembalian' -->
        <li
            class="menu-item {{ $active == 'menu-header' ||
            $active == 'our-team' ||
            $active == 'our-story' ||
            $active == 'our-vision' ||
            $active == 'award' ||
