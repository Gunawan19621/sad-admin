...
@section('content')
    ...
    <div class="card mb-2">
        ...
        <div class="card-body">
            <form action="{{ route('dashboard.user-management.store') }}" method="POST" enctype="multipart/form-data"
                id="inputanForm">
                @csrf
                <div class="row g-3">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" id="phone" name="phone"
                                placeholder="Enter user phone number" pattern="[0-9+\-\(\)\s]*"
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" name="address" id="address" cols="30" rows="3"
                        placeholder="Enter the user address"></textarea>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <input class="form-control" type="password" id="password" name="password"
                            placeholder="Enter the user password" required>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <input class="form-control" type="password" id="confirm_password" name="password_confirmation"
                            placeholder="Enter the user confirm password" required>
                        <span class="input-group-text password-toggle"><i class="menu-icon tf-icons bx bx-show"></i></span>
                    </div>
                </div>
