...
@section('title', 'Category News & Event')
@section('content')
    <!-- Alert -->
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-6">
                    <h5 class="card-header">Category News & Event</h5>
                </div>
                ...
                <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                        @php
                            $no = 1;
                        @endphp
                        @forelse ($categoryNewsEvent as $items)
                            <tr>
                                <td>{{ $no++ }}</td>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('dashboard.category-news-event.destroy', $items->id) }}"
    ...
    <!-- Modal -->
    @include('pages.admin.layouts.news-event.category-news-event.modals')
@endsection
