...
@section('content')
                    ...
                    <tbody class="table-border-bottom-0">
                        ...
                        @forelse ($award as $items)
                            <tr>
                                <td>{{ $no++ }}</td>
                                <td>
                                    @if (!empty($items->image_awards))
                                        <img src="{{ asset('images/' . $items->image_awards) }}" alt="Image Team"
                                            class="img-fluid" style="max-width: 50px;">
                                    @else
                                        -
                                    @endif
                                </td>
                                <td>{{ $items->title_awards ?? '-' }}</td>
                                <td>
    ...
    <!-- Modal -->
    @include('pages.admin.layouts.award.modals')
@endsection
