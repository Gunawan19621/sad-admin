...
@section('content')
    ...
    <div class="card mb-2">
        ...
        <div class="card-body">
            <form action="{{ route('dashboard.suade-product.store') }}" method="POST" enctype="multipart/form-data"
                id="inputanForm">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="category_id" id="category_id" class="form-select" required>
                                ...
                                @foreach ($productCategory as $list)
                                    <option value="{{ $list->id }}">{{ $list->name_category }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="type_id" id="type_id" class="form-select" required>
                                ...
                                @foreach ($productType as $list)
                                    <option value="{{ $list->id }}">{{ $list->name_type }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label class="form-label" for="discount_product">Discount Product <span
                                    class="text-danger">*</span></label>
                            <div class="input-group">
                                <input class="form-control" type="number" id="discount_product" name="discount_product"
                                    placeholder="Enter Price Product" required />
                ...
                <div class="mb-3">
                    <label class="form-label" for="subtitle_product">Subtitle Product</label>
                    <textarea class="form-control" name="subtitle_product" id="subtitle_product" cols="30" rows="3"
                        placeholder="Enter Subtitle Product"></textarea>
                </div>

                <div class="mb-3">
                    <label class="form-label" for="description_product">Description Product</label>
                    <textarea class="form-control" name="description_product" id="description_product" cols="30" rows="3"></textarea>
                </div>

                <div class="mb-3">
                    <label class="form-label" for="additional_product">Additional Product</label>
                    <textarea class="form-control" name="additional_product" id="additional_product" cols="30" rows="3"></textarea>
                </div>
