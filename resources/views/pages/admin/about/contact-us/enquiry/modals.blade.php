                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="enquiring" name="enquiring">
                                        <option disabled selected>Select one</option>
                                        @foreach ($typeQuestion as $data)
                                            <option value="{{ $data->id }}"
                                                {{ $itemModals->enquiring == $data->id ? 'selected' : '' }}>
                                                {{ $data->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
...
@foreach ($enquiry as $itemModals)
    <div class="modal fade bd-example-modal-lg" id="modalShow{{ $itemModals->id }}" tabindex="-1"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Show Enquiry</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control" id="name" value="{{ $itemModals->name }}"
                                    readonly />
                            </div>
                            <div class="mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                <label class="form-label" for="enquiring">Enquiring</label>
                                <select class="form-select" id="enquiring" name="enquiring" disabled>
                                    <option disabled selected>Select one</option>
                                    @foreach ($typeQuestion as $data)
                                        <option value="{{ $data->id }}"
                                            {{ $itemModals->enquiring == $data->id ? 'selected' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="id_distributor" disabled>
                            <option>{{ $itemModals->our_newsletter }}</option>
                        </select>
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="message">Message</label>
                        <textarea id="message" class="form-control" rows="3" readonly>{{ $itemModals->message }}</textarea>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
